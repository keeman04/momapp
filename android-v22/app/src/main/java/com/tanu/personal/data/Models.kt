...
object MeetingStatus {
    const val RECORDING="RECORDING"; const val TRANSCRIBING="TRANSCRIBING"; const val GENERATING_MOM="GENERATING_MOM"; const val READY="READY"; const val FAILED="FAILED"
}
object ChunkStatus { const val PENDING="PENDING"; const val PROCESSING="PROCESSING"; const val DONE="DONE"; const val FAILED="FAILED" }
object ProcessingMode { const val FAST="FAST"; const val PRIVATE="PRIVATE" }
...
data class MeetingEntity(
    ...
    val processingMode:String=ProcessingMode.FAST,
